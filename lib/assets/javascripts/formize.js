...
$(function(event) {
	...
	choices = element.attr('data-choices-container');
	if (choices === null) {
	    var choices_id = Formize.uniqueID();
	    element.after($(document.createElement('div'))).attr({
		'id': choices_id,
		'class': "unroll-choices",
		'style': "display: none"
	    });
	    element.attr('data-choices-container', choices_id);
	}
